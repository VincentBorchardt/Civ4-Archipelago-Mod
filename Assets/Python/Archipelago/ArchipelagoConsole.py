...
class ArchipelagoConsole:
    ...
    def interfaceScreen(self):
        ...
        screen.addPanel("ConsoleBg", "", "", True, False, 0, 0, self.W_SCREEN, self.H_SCREEN, PanelStyles.PANEL_STYLE_MAIN)
        ...
        screen.setLabel("ConsoleHeader", "ConsoleBg", "<font=4b>Archipelago Server Log</font>", CvUtil.FONT_CENTER_JUSTIFY, self.W_SCREEN / 2, 15, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
        ...
        screen.addScrollPanel(scroll_panel_id, "", 20, 50, panel_w, panel_h, PanelStyles.PANEL_STYLE_EXTERNAL)

        # 4. Populate with coordinates to force independent scrollbar tracking
        line_height = 22
        for i in range(50):
            label_id = "ConsoleLine_" + str(i)
            text_string = "Server Packet Line Tracker Log Entry " + str(i)
        ...
        screen.setButtonGFC("CloseConsoleBtn", "Close Window", "", (self.W_SCREEN / 2) - 60, self.H_SCREEN - 50, 120, 30, WidgetTypes.WIDGET_CLOSE_SCREEN, -1, -1, ButtonStyles.BUTTON_STYLE_STANDARD)
